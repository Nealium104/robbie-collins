                ...
                <div className="card-body items-center text-center">
                    <h2 className="card-title font-thin text-2xl">Contact me for opportunities and lessons here:</h2>
                        <form action="post" onSubmit={handleOnSubmit}>
                            ...
                            {loading ? (
                                <div
                                class="inline-block h-8 w-8 py-6 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
                                role="status">
